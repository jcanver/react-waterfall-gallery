...
export const getStarts = (top, bottom, left, right) => ({
...
export const getFinishes = (top, bottom, left, right) => ({
...
export const getDefaultStyles = (speed, styles = {}) => ({
...
export const getTransitionStyles = (top, bottom, left, right) => ({
